...
import com.shop.spring.shop.dto.OrderDto;
import com.shop.spring.shop.dto.OrderHisDto;
import com.shop.spring.shop.dto.OrderItemDto;
import com.shop.spring.shop.entity.*;
...
import com.shop.spring.shop.repository.OrderRepository;
    ...
    public Page<OrderHisDto> getOrderList(String email, Pageable pageable) {
        ...
        for (Order order : orders) {
            ...
            for (OrderItem orderItem : orderItems) {
                ItemImg itemImg = itemImgRepository.findByIdAndRepimgYn(orderItem.getId(), "Y");
